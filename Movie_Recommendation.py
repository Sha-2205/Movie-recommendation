...
set_background(root, r"C:\\Users\\Lenovo\\Pictures\\Screenshots\\cinema.jpg")  # Home Page Background
...
# Add a welcome label
welcome_label = tk.Label(root, text="Welcome to the Movie Recommendation System", font=("Arial", 24, "bold"),fg="white",bg="black")
welcome_label.place(relx=0.5, rely=0.3, anchor="center")  # Add padding to prevent overlap

# Add a description label
description_label = tk.Label(root, text="Explore a wide selection of movies from various genres.", font=("Arial", 16),fg="white",bg="black")
description_label.place(relx=0.5, rely=0.4, anchor="center") # Add padding to ensure no overlap with other widgets
...
def open_genre_page():
    ...
    #set_background(root, r"C:\\Users\\Lenovo\\Pictures\\Screenshots\\cinema.jpg")  # Genre Page Background
...
start_button = tk.Button(
    ...
    font=("Arial", 16),
    command=open_genre_page,
    bg="#080347",
    fg="#CFC9C9",
    activebackground="#080347",
    activeforeground="#CFC9C9",
    borderwidth=0,
...
def show_movies(genre):
    ...
    # Create a frame inside the canvas to hold the movie list
    ...
    # Add this block to enable Down and Up arrow scrolling
    def on_down_arrow(event):
        canvas.yview_scroll(1, "units")  # Scroll down by one unit

    def on_up_arrow(event):
        canvas.yview_scroll(-1, "units")  # Scroll up by one unit

    movie_window.bind("<Down>", on_down_arrow)
    movie_window.bind("<Up>", on_up_arrow)
...
def create_genre_buttons():
    ...
    for genre in movies.keys():
        genre_button = tk.Button(
            ...
            text=genre,
            font=("Arial", 14),
            command=lambda g=genre: show_movies(g),
            bg="#0E0953",
            fg="#CFC9C9",
            activebackground="#36317A",
            activeforeground="#CFC9C9",
            borderwidth=0,
            highlightthickness=0
        )
        genre_button.place(relx=0.5, rely=y, anchor="center")
        y += 0.07  # Adjust spacing as needed
